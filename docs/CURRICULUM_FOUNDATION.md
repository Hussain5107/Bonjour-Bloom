...
The pilot contains 2 modules, 6 lessons, 6 shared objectives, 3 variants per lesson, and 48 French words/phrases. Five lessons map or extend already shipped material and are shown as published in the local compatibility pilot. “How are you?” remains `in_review` because qualified French editorial review has not been verified. Its provenance explicitly records that limitation.
